...
class Inquirer {
  constructor() {
    ...
    this.questions = [
      ...
      {
        type: 'input',
        message: "If you would like your logo to have a solid BACKGROUND COLOR, please enter a color keyword/hexadecimal number. If you would like a transparent background, hit 'Return/Enter'",
  ...
  run() {
    return inquirer
      ...
      .then(({logoText, textColor, shape, shapeColor, backgroundColor}) => {
...
Error: More than 3 characters were entered; please try again with three or fewer characters.
    `)
          ...
          const logo = setLogoProperties(logoText, textColor, shape, shapeColor, backgroundColor);
